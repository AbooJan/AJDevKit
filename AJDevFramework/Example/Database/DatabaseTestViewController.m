...
//    JWBarButtonItem *addBarItem = [[JWBarButtonItem alloc] initWithTitle:@"添加" target:self action:@selector(addBarItemClick)];
//    addBarItem.showColor = [UIColor whiteColor];
//    
//    JWBarButtonItem *clearBarItem = [[JWBarButtonItem alloc] initWithTitle:@"清空" target:self action:@selector(cleanData)];
//    
//    JWBarButtonItem *queryBarItem = [[JWBarButtonItem alloc] initWithTitle:@"查询" target:self action:@selector(queryData)];
//    queryBarItem.showColor = [UIColor whiteColor];
//    
//    self.navigationItem.rightBarButtonItems = @[addBarItem, clearBarItem, queryBarItem];
}
